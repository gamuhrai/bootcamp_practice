...
d3.select(".my-link>a").attr("href", "https://google.com").text("Now this is a link to the GOOGLE!!");
...
let li2 = d3.select("ul").append("li").text("Another new item!").style("color", "red");
